...
CUSTOM_PACKAGES="$CUSTOM_PACKAGES geoview v2ray-geosite v2ray-geoip xray-core sing-box hysteria kmod-nft-socket kmod-nft-tproxy luci-i18n-passwall-zh-cn"
